...
Добро пожаловать в мое портфолио разработчика. Я увлечен созданием инструментов, игр и приложений, которые решают реальные задачи или просто дарят удовольствие. В основном работаю с **C++**, **C#**, **Python** и **JavaScript**.

---

## 🛠️ Мои проекты

Здесь собраны некоторые из моих работ — от низкоуровневых утилит до веб-игр.
...
- 🔭 Сейчас я работаю над улучшением своих проектов на **C++** и **Python**.
- 🌱 Постоянно изучаю новые подходы в разработке под **Wayland** и создании ботов.
- 👯 Открыт к сотрудничеству по небольшим игровым или инструментальным проектам.
- 📫 Как со мной связаться? Напиши issue в любом из моих репозиториев.
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=SitHond&show_icons=true&theme=dark" alt="Статистика SitHond" width="48%">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=SitHond&theme=dark" alt="Серия коммитов" width="48%">
</p>

---

*Спасибо, что заглянули! Не забывайте оставлять ⭐ понравившимся проектам.*
